    ...
    <div className="grid gap-6">
      <Card className="border-border/60 shadow-sm">
        <CardHeader className="border-b">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <CardTitle className="flex items-center gap-2.5">
              ...
              {isNew ? 'Nuovo bot' : 'Configurazione'}
            </CardTitle>
        ...
        <CardContent className="grid gap-6 pt-6">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="grid gap-2">
              <Label htmlFor="default-template-name" className="text-sm font-semibold">Template outbound di default</Label>
              <Input
          ...
          <div className="grid gap-2">
            <Label htmlFor="qualification-statuses" className="text-sm font-semibold">Stati di qualifica</Label>
            <Input
